...
class Node(models.Model):
    ...
    is_last = models.IntegerField(default=0, verbose_name='是否为最终节点')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
    updated_at = models.DateTimeField(auto_now=True, verbose_name='更新时间')
...
class Task(models.Model):
    ...
    create_user = models.CharField(max_length=100, verbose_name='任务创建人')
    ...
    next_charge = models.CharField(max_length=100, default='', verbose_name='下一步负责人')
